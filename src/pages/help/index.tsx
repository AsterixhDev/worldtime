    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="!pt-16 pb-8 lg:pl-72 max-w-6xl mx-auto p-4 lg:p-6">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-foreground mb-4">Help Center — WorldTimeSage</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Learn how to use WorldTimeSage to track time across the globe. From basic setup to advanced features,
          ...
          <div className="flex items-start mb-4">
            ...
            <div>
              ...
              <p className="text-blue-800 dark:text-blue-200">
                WorldTimeSage works offline for previously viewed content, so you can check times even without a connection.
              </p>
            </div>
          </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Make WorldTimeSage work the way you want it to.</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8">
          <div className="flex items-start mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold text-green-900 dark:text-green-100 mb-2">Get WorldTimeSage on Your Device</h3>
              <p className="text-green-800 dark:text-green-200">
                Install WorldTimeSage as a Progressive Web App for the full native app experience.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Find WorldTimeSage in your app list</p>
            </div>
          </div>
